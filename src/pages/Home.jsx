        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 py-20 md:py-28">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a href="https://bifrost.omixsystems.store" className="inline-flex items-center gap-2 rounded-lg border border-slate-300 bg-white px-5 py-3 font-semibold text-slate-800 hover:border-slate-500 transition-colors">Explore Bifrost <ArrowRight size={16} /></a>
            </div>
          </div>
        </div>
      </section>
